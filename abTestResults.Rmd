...
Binomial Metric {data-icon="fa-percentage"}
===================================== 
...
inputPanel(
  ...
  # checkboxInput("descToggle", label = "Show test description panel", value = FALSE),
  
  textInput("hypo", label = "Test hypothesis", value = "If [this] then [that will happen] because [we have evidence]."),
...
# EXPERIMENTAL FOR EXPORT TO PDF
...
output$testheader <- renderUI({
  div(
      ...
      div(id = "hypothesis",
          p(paste0("Test hypothesis: ",input$hypo))),
      div(id = "imagesboth", 
          div(id = "ssA",
