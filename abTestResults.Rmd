...
observeEvent(input$metric,{
  if (input$metric == "Binomial (Conversion Rate)") {
    ...
    lab_val <- "What's the approximate $ value an increment of 1 in your KPI for one visitor or visit?"
    lab_vol <- "About how many visits or visitors per month would this change impact?"
  }
